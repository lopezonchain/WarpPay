...
const AirdropScreen: React.FC<AirdropScreenProps> = ({ address, onBack }) => {
  ...
  const handleShare = useCallback(() => {
    const text = `I've just sent an airdrop with WarpPay!! The all-in-one payments miniapp by @lopezonchain.eth 🚀 Send anything, anywhere to anyone just with a farcaster name, create request links, scheduled transfers, or even EARN! warppay.lopezonchain.xyz `;
