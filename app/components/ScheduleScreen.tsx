...
export default function ScheduleScreen({ onBack }: { onBack: () => void }) {
  ...
  const handleShare = useCallback(() => {
    const text = `I've just created a scheduled transfer with WarpPay!! The all-in-one payments miniapp by @lopezonchain.eth 🚀 Send anything, anywhere to anyone just with a farcaster name or ENS, create request links, airdrops, or even EARN! https://farcaster.xyz/miniapps/V0727cQCBnfX/warppay- `;
